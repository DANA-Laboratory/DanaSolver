  ...
  function CompPolyVS_Hyper()
    ...
    h_hyper::Array{Float64,1}=Array(Float64,0)
      ...
      DNIdelHyper=DANAIdealGasEos()
			DNIdelPoly.T=T
			DNIdelHyper.T=T
      DNIdelPoly.CASNO="107-02-8" # 
      DNIdelHyper.CASNO="107-02-8" # 
      DNIdelPoly.usePolynomialEstimationOfCp=true
      DNIdelHyper.usePolynomialEstimationOfCp=false
      DNIdelPoly.C1,DNIdelPoly.C2,DNIdelPoly.C3,DNIdelPoly.C4,DNIdelPoly.C5 = getValueForCasNo("C0Poly",DNIdelPoly.CASNO)
      DNIdelHyper.C1,DNIdelHyper.C2,DNIdelHyper.C3,DNIdelHyper.C4,DNIdelHyper.C5 = getValueForCasNo("C0Hyper",DNIdelHyper.CASNO)
